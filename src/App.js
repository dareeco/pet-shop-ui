...
import OwnedPets from "./components/ownedPets";
  ...
  return (
    <Router>
      <>
        ...
        <Routes>
          <Route path="/components/pets" element={<Pets />} />
          <Route path="/components/users" element={<Users />} />
          <Route path="/components/ownedPets" element={<OwnedPets />} />
        </Routes>
      </>
    </Router>
  );
